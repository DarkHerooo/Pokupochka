...
namespace DbLib.Migrations
{
    ...
    [Migration("20220603124305_add-many-to-many-productRequest")]
    partial class addmanytomanyproductRequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbLib.DB.Entity.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DbLib.DB.Entity.ProductWarehouse", b =>
                {
                    ...
                    b.HasOne("DbLib.DB.Entity.Warehouse", "Warehouse")
                        .WithMany("ProductWarehouses")
                        .HasForeignKey("WarehouseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
